...
const coordinatesRegex = new RegExp("[-]?[0-9]*[.][0-9]*[,][-]?[0-9]*[.][0-9]*");
...
const BookingSiteSchema = new Schema(
    {
        home_type:{
            ...
            required:true,
            enum:{
                values:["apartment","house","attachedhouse", "uniqueaccommodation", "bedandbreakfasts", "hotelboutique"],
        ...
        description_type:{
            ...
            required:true,
            enum:{
                values:["lodging","cottage","villa", "terraced-house", "cabin", "bungalow","hut","farm","dome", "chalet", "tiny-house", "houseroom","holiday-accommodation"],
        ...
        services:{
            ...
            required:true,
            enum:{
                values:["pool","jacuzzi","bbq","woodfire", "essentialservices","hotwater", "wifi", "tv", "kitchen","washer","airconditioner", "firstaidkit"],
        ...
        description:{
            type:String,
            required:true,
            match:[commentRegex, "description must contain only letters and numbers"],
